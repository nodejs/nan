...
static v8::Persistent<v8::FunctionTemplate> namedinterceptors_constructor;
...
void NamedInterceptor::Init(v8::Handle<v8::Object> target) {
  ...
  NanAssignPersistent(namedinterceptors_constructor, tpl);
  tpl->SetClassName(NanNew<v8::String>("NamedInterceptor"));
